app.controller("crudCtrl", function($scope, crudService){
    ...
    function obterCelulares() {
        ...
        celularesData.then(function (celular) {
            ...
            toastr["error"]("Erro ao obter os celulares", "DevMedia - CRUD com MVC e Angulst JS");
        });
    }
    ...
    $scope.excluirCelular = function (celular) {
        ...
        celularData.then(function (data) {
            if (data.status == 200) {
                toastr["success"]("Celular excluido com sucesso!", "DevMedia - CRUD com MVC e Angulst JS");
            }
            obterCelulares();
        }, function () {
            toastr["error"]("Erro ao excluir celulare", "DevMedia - CRUD com MVC e Angulst JS");
        });
    }
    ...
    $scope.obterPorId = function (celular) {
        ...
        celularData.then(function (_celular) {
            ...
            toastr["error"]("Erro ao obter celular por Id!", "DevMedia - CRUD com MVC e Angulst JS");
        });
    }
